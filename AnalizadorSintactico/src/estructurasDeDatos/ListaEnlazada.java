...
public class ListaEnlazada {
  ...
  /**
   * Elimina los nodos cuya información se repita en la lista. Funciona para 
   * listas < String >
   * 
   */
//  public void eliminarRepetidos(){
//    String tempInfo, temp2Info;
//    int coincidencias, index;
//    coincidencias = 0;
//    index = 0;
//    
//    for(Nodo temp = inicio; temp !=null ; temp = temp.getSiguiente()){
//      tempInfo = (String) temp.getInfo();
//      for(Nodo temp2 = inicio; temp2 !=null ; temp2 = temp2.getSiguiente()){
//        temp2Info = (String) temp2.getInfo();
//        if(tempInfo.equals(temp2.getInfo()))
//          coincidencias++;
//        if(coincidencias > 1)
//          
//      }
